        ...
        public int maximumCandies(int[] candies, long k) {
            ...
            while (left < right) {
                ...
                if (canAllocateCandies(candies, k, middle)) {//
                   // اذا زبط انها تتقسم بضمن انو الاكبر من هاد العدد ممكن يكون بزبط فبلغي قسم الشمال وبخلي قسم الرايت يلي خهو الاكبر 
                   //بس بضل محافظة انو ممكن الميدل يزبط 
                    // If possible, move to the upper half to search for a larger number
                    left = middle;
                } else {
                    // Otherwise, move to the lower half
                    right = middle - 1;//2 5 6 
                }
            }
